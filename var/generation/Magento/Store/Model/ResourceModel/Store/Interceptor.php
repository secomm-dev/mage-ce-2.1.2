...
/**
 * Interceptor class for @see \Magento\Store\Model\ResourceModel\Store
 */
class Interceptor extends \Magento\Store\Model\ResourceModel\Store implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function countAll($countAdmin = false)
    {
        ...
        if (!$pluginInfo) {
            return parent::countAll($countAdmin);
        } else {
